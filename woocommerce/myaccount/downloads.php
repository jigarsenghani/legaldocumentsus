...
//							echo "<a class='woocommerce-MyAccount-downloads-file button alt ".$fetchControlNo["formEXT"]." ' href=".$fetchControlNo["href"]." style='margin: 5px;' >".ucfirst($fetchControlNo["formEXT"])."</a>";
							...
							switch(strtolower($fetchControlNo["formEXT"])){
								case 'doc': echo "<image width='24px' height='24px' src='".UL_PLUGIN_URL."images/doc_icon.png' alt='Download doc' data-toggle='tooltip'  title='Download Doc'>";
									       break;
                                case 'rtf': echo "<image width='24px' data-toggle='tooltip' height='24px' src='".UL_PLUGIN_URL."images/rtf_icon.png' alt='Download RTF' title='Download RTF'>";
									       //echo ucfirst($fetchSample["formEXT"]);
									       break;
                                case 'pdf': echo "<image width='24px' data-toggle='tooltip'  height='24px' src='".UL_PLUGIN_URL."images/pdf_icon.png' alt='Download PDF' title='Download PDF'>";
									       //echo ucfirst($fetchSample["formEXT"]);
									       break;
				...
				<?php else: 
					...
					if($data)			
						{
							echo '<a href="' . esc_url( $data['download_url'] ) . '" class="woocommerce-MyAccount-downloads-file button alt">' . esc_html( 'Download' ) . '</a>';
				...
				<?php 
						foreach($arrayfile[0]['fetchSample'] as $fetchSample)
						{
							...
							switch(strtolower($fetchSample["formEXT"])){
								case 'doc': echo "<image width='24px' data-toggle='tooltip' height='24px' src='".UL_PLUGIN_URL."images/doc_icon.png' alt='Download doc' title='Download Doc'>";
									       break;
                                case 'rtf': echo "<image width='24px'  data-toggle='tooltip' height='24px' src='".UL_PLUGIN_URL."images/rtf_icon.png' alt='Download RTF' title='Download RTF'>";
									       //echo ucfirst($fetchSample["formEXT"]);
									       break;
